export const distantTerrainVertexShader = `
    #version 300 es
...
export const distantTerrainFragmentShader = `
    #version 300 es
...
export const distantWaterVertexShader = `
    #version 300 es
    precision highp float;
    in vec3 position;
    uniform mat4 world;
...
export const distantWaterFragmentShader = `
    #version 300 es
    precision highp float;
    in vec3 vPositionW;

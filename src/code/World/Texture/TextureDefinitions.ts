...
export const TextureDefinitions: TextureDefinition[] = [
  { id: 1, name: "cobble", path: "/texture/cobble/cobble05_1k" },
  { id: 2, name: "factory_wall", path: "/texture/metal/factory_wall_1k" },
  { id: 3, name: "gravelly_sand", path: "/texture/sand/gravelly_sand_1k" },
  { id: 4, name: "brick_wall_10", path: "/texture/brick/brick_wall_10_1k" },
  {
    id: 5,
    name: "castle_brick_red",
    path: "/texture/brick/castle_brick_02_red_1k",
  },
  { id: 6, name: "metal01", path: "/texture/metal/metal01_1k" },
  {
    id: 7,
    name: "concrete_tile_facade",
    path: "/texture/stone/concrete_tile_facade_1k",
  },
  { id: 8, name: "gray_rocks", path: "/texture/stone/gray_rocks_1k" },
  {
    id: 9,
    name: "stone_tile_wall",
    path: "/texture/stone/stone_tile_wall_1k",
  },
  { id: 10, name: "bark_willow_02", path: "/texture/wood/bark_willow_02_1k" },
  {
    id: 11,
    name: "diagonal_parquet",
    path: "/texture/wood/diagonal_parquet_1k",
  },
  { id: 12, name: "old_wood_floor", path: "/texture/wood/old_wood_floor_1k" },
  { id: 13, name: "wood_table", path: "/texture/wood/wood_table_1k" },
  {
    id: 14,
    name: "rocky_terrain_02",
    path: "/texture/dirt/rocky_terrain_02_1k",
  },
  { id: 15, name: "grass001", path: "/texture/dirt/Grass001_1K" },
  {
    id: 16,
  ...
  { id: 20, name: "rock_wall_12", path: "/texture/stone/rock_wall_12_1k" },
  {
    id: 21,
